...
<tiles:insertDefinition name="DashboardMangerTemplate">
    ...
    <div class="matter">
      ...
      <form:form  modelAttribute="file" method="post" action="${pageContext.request.contextPath}/dashboard/${sprint.id_sprint}/file/update/${file.id_attachement}" enctype="multipart/form-data">
        <div class="modal-content">
          <div class="modal-header">
            <!--full screen icon - custom.js-->
            <button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
            <!--full screen icon - custom.js-->
            <h4 class="modal-title">  <spring:message code="application.header.update.dashboardmanager.project.file"/> </h4>
          </div>
