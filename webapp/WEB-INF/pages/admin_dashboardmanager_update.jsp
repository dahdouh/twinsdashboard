...
<tiles:insertDefinition name="AdminTemplate">
    ...
    <div class="modal-dialog">
      <form:form  modelAttribute="dashboardmanager" method="post" action="${pageContext.request.contextPath}/admin/dashboardmanager/update/${dashboardmanager.id_u}">
        <div class="modal-content">
          <div class="modal-header">
            <!--full screen icon - custom.js-->
            <button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
            <!--full screen icon - custom.js-->
            <h4 class="modal-title">  <spring:message code="application.header.update.dashboardmanager"/> </h4>
          </div>
          <div class="modal-body">
            <div class="form-group" style="margin-bottom:10px;">
              ...
              <div class="col-lg-12">
               ...
               <label class="jquery-validation-error" for="prenom"> <form:errors path="prenom" cssClass="error" /> </label>
              </div>
            </div>
            ...
            <div class="form-group" style="margin-bottom:10px;">
              ...
              <div class="col-lg-12">
               ...
               <label class="jquery-validation-error" for="nom"> <form:errors path="nom" cssClass="error" /> </label>
              </div>
            </div>
            ...
            <div class="form-group" style="margin-bottom:10px;">
              ...
              <div class="col-lg-12">
               ...
               <label class="jquery-validation-error" for="email"> <form:errors path="email" cssClass="error" /> </label>
              </div>
            </div>
            <div class="form-group" style="margin-bottom:10px;">
              ...
              <div class="col-lg-12">
               ...
               <label class="jquery-validation-error" for="tel"> <form:errors path="tel" cssClass="error" /> </label>
              </div>
            </div>
            <div class="form-group" style="margin-bottom:10px;">
             ...
             <div class="col-lg-12">
               ...
               <label class="jquery-validation-error" for="adresse"> <form:errors path="adresse" cssClass="error" /> </label>
              </div>
            </div>
