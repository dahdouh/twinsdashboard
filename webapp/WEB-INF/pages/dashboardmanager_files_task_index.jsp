		        ...
		        <div class="container-fluid">
		          ...
		          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			             
		              ...
		              <div class="navbar-form navbar-left form-small"> 
			              ...
			              <a class="form-group" href ="${pageContext.request.contextPath}/dashboard/${sprint.id_sprint}/file/task/${idT}/add"> 
			                ...
			                <table class="footable table table-bordered table-hover default footable-loaded">
			                  ...
			                  <tbody>
				                    ...
				                    <tr>
				                      ...
				                      <td class="footable-visible">
				                      	   <a href="${pageContext.request.contextPath}/dashboard/${sprint.id_sprint}/file/download/${c.id_attachement}">
				                      ...
				                      <td class="tr-link-excluded footable-visible footable-last-column"> 
				                       <span>
				                        ...
				                        onclick="location.href = '${pageContext.request.contextPath}/dashboard/${sprint.id_sprint}/file/task/${idT}/update/${c.id_attachement}';"> <i class="icon-edit"></i> </button>
				                       </span>
				                      ...
				                      <span>
				                       <button title="" data-original-title="" class="btn btn-xs btn-danger ajax-delete-record" data-popconfirm-yes="<spring:message code="application.crud.yes"/>" data-popconfirm-no="<spring:message code="application.crud.no"/>" 
				                        ...
				                        onclick="location.href = '${pageContext.request.contextPath}/dashboard/${sprint.id_sprint}/file/task/${idT}/delete/${c.id_attachement}';"> <i class="icon-trash"></i> </button>
				                      </span>
