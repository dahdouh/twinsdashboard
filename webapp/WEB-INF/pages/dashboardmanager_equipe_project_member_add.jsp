                ...
                <!-----------------------------------------------CONTENT CHANGES------------------------------------------------------------------>
		      		...
		      		<div class="modal-dialog">
					    <c:choose>
					     ...
					     <form:form  modelAttribute="projet" method="post" action="${pageContext.request.contextPath}/dashboard/${idP}/team/${idE}/member/add">
							                   ...
							                   <tbody>
							                    ...
							                    <tr>
							                      ...
							                      <td colspan="4"><div align="center">
							                          <p>&nbsp;</p>
							                          <p>&nbsp;</p>
							                          <h2> Tous les membres travaille avec une équipe, veuillez ajouter une nouveau membre. </h2>
							                          <p>&nbsp;</p>
							                          <p>&nbsp;</p>
							                        </div></td>
							                    </tr>
