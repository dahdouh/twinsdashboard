...
<tiles:insertDefinition name="DashboardMangerTemplate">
    ...
    <div class="matter">
			...
			<div class="row">
			  ...
			  <div class="col-lg-12">
			    <div class="split-info-panel project">
			      <div class="split-info-panel-header bg-info"> <span class="split-panel-heading"> <spring:message code="application.header.table.file"/></span> </div>
      ...
      <form:form  modelAttribute="file" method="post" action="${pageContext.request.contextPath}/dashboard/${projet.id_projet}/file/project_add" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <div class="form-group" style="margin-bottom:10px;">
              <label class="control-label col-lg-12" style="width:150px;"> <spring:message code="application.sprint"/> <span class="required_field">*</span></label>
              <div class="col-lg-12">       
			      <div class="navbar navbar-default" style="background:#fff; border:0px; margin:0px;" role="navigation">
			 				<select class="custom-select" name="id_sprint">
				                    		<c:forEach var="crt" items="${sprints}">
												<option value="${crt.id_sprint}"> <c:out value="${crt.nom}" /> </option>
											</c:forEach>																
							</select>
			      </div>
              </div>
