      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			
            <form class="navbar-form navbar-left form-small" method="post" action="${pageContext.request.contextPath}/admin/client/search">
				...
				<div class="form-group">
				<button class="btn btn-primary" type="submit"> <spring:message code="application.header.search.client"/></button>
				</div>
			</form>
              ...
              <div class="navbar-form navbar-left form-small">   
	              <a class="form-group" href ="${pageContext.request.contextPath}/admin/client/add"> 
	              	<button href="" class="btn btn-success" >  <i class="icon-plus"></i> <spring:message code="application.header.add.client"/></button>
	              </a>
              </div>
            ...
            <div class="widget">
              <div class="widget-content">
              	 ...
              	 <div class="widget-foot">
	                 <!--WI_PAGINATION-->
	                 <ul class="">
	                   <li><h2> <spring:message code="application.header.table.client"/> </h2></li>
	                 </ul>
	                 <!--WI_PAGINATION-->
			 ...
			 <c:when test="${not empty clients}">
	                <table class="footable table table-bordered table-hover default footable-loaded">
	                  <thead>
	                    <tr>
	                    <th class="footable-visible">  <spring:message code="application.user.societe"/></th>
	                  ...
	                  <tbody>
		                    ...
		                    <tr>
		                      <td class="footable-visible"> ${c.societe}</td>
		                      ...
		                      <!--edit-->
		                        ...
		                        onclick="location.href = '${pageContext.request.contextPath}/admin/client/update/${c.id_u}';"> <i class="icon-edit"></i> </button>
		                       </span>
		                      </td>
		                      <td>
		                      <span>
		                       <button title="" data-original-title="" class="btn btn-xs btn-danger ajax-delete-record" data-popconfirm-yes="<spring:message code="application.crud.yes"/>" data-popconfirm-no="<spring:message code="application.crud.no"/>" 
		                        ...
		                        onclick="location.href = '${pageContext.request.contextPath}/admin/client/delete/${c.id_u}';"> <i class="icon-trash"></i> </button>
		                       </span>
		                        <!--delete -->
