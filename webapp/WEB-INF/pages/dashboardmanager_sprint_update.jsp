...
<tiles:insertDefinition name="DashboardMangerTemplate">
    ...
    <div class="matter">
			    ...
			    <div class="box side-menu-main">
			      ...
			      <div class="box-content">
			        <ul>
			          ...
			          <li>     
			            <a class="" href="${pageContext.request.contextPath}/dashboard/${idP}/task/"><spring:message code="application.bashboardmanager.project.tasks"/></a>
			          </li>
			
			          <li>
			             <a class="" href="${pageContext.request.contextPath}/dashboard/${idP}/team/"> <spring:message code="application.bashboardmanager.project.teamproject"/></a>
			           </li>
			
			          <li> 
			          	 <a class="" href="${pageContext.request.contextPath}/dashboard/${idP}/file/"> <spring:message code="application.bashboardmanager.project.Files"/></a>
			          </li>
			          <li> 
			          	 <a class="" href="${pageContext.request.contextPath}/dashboard/${idP}/event/"> <spring:message code="application.bashboardmanager.project.event"/></a>
			          </li>
      ...
      <form:form  modelAttribute="sprint" method="post" action="${pageContext.request.contextPath}/dashboard/${idP}/sprint/update/${sprint.id_sprint}">
        <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <div class="form-group" style="margin-bottom:10px;">
             ...
             <div class="col-lg-12">
               <form:input class="form-control pickadate" path="date_debut" />
            ...
            <div class="form-group" style="margin-bottom:10px;">
              ...
              <div class="col-lg-12">
               <form:input class="form-control pickadate" path="date_fin" />
