      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			
            <form class="navbar-form navbar-left form-small" method="post" action="${pageContext.request.contextPath}/admin/chefprojet/search">
				...
				<div class="form-group">
				<button class="btn btn-primary" type="submit"> <spring:message code="application.header.search.chefprojet"/></button>
				</div>
			</form>
              ...
              <div class="navbar-form navbar-left form-small"> 
	              ...
	              <a class="form-group" href ="${pageContext.request.contextPath}/admin/chefprojet/add"> 
	              	<button href="" class="btn btn-success" >  <i class="icon-plus"></i> <spring:message code="application.header.add.chefprojet"/></button>
	              </a>
              </div>
            ...
            <div class="widget">
              <div class="widget-content">
              	...
              	<div class="widget-foot">
	                 <!--WI_PAGINATION-->
	                 <ul class="">
	                   <li><h2> <spring:message code="application.header.table.chefprojet"/> </h2></li>
	                 </ul>
	                 <!--WI_PAGINATION-->
              ...
              <c:choose>
			 <c:when test="${not empty chefprojets}">
	                <table class="footable table table-bordered table-hover default footable-loaded">
	                  ...
	                  <tbody>
                  			<c:forEach items="${chefprojets}" var="c" >
		                    <tr>
		                      <td class="footable-visible"> ${c.nom}</td>
		                      <td class="footable-visible">${c.prenom}
		                      </td>
		                      <td class="footable-visible">${c.tel}</td>
		                      <td class="footable-visible">${c.email}</td>
		                      ...
		                      <!--edit-->
		                        ...
		                        onclick="location.href = '${pageContext.request.contextPath}/admin/chefprojet/update/${c.id_u}';"> <i class="icon-edit"></i> </button>
		                       </span>
		                      </td>
		                      <td>
		                      <span>
		                       <button title="" data-original-title="" class="btn btn-xs btn-danger ajax-delete-record" data-popconfirm-yes="<spring:message code="application.crud.yes"/>" data-popconfirm-no="<spring:message code="application.crud.no"/>" 
		                        ...
		                        onclick="location.href = '${pageContext.request.contextPath}/admin/chefprojet/delete/${c.id_u}';"> <i class="icon-trash"></i> </button>
		                       </span>
		                        <!--delete -->
			                  ...
			                  <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td colspan="4"><div align="center">
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                          <h2> Aucun Chef projet n'est trouvé. </h2>
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                        </div></td>
			                    </tr>
