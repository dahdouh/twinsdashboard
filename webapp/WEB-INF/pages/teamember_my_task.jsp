				...
				<c:otherwise>
						...
						<div style="padding-bottom:0px;">
			                  ...
			                  <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td colspan="4"><div align="center">
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                          <h2> Aucun Projet n'est trouvé. </h2>
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                        </div></td>
			                    </tr>
               			...
               			<div class="widget-foot">
								...
								Information:
								<button class="btn btn-xs tooltips" title="" data-original-title="<spring:message code="application.fotter.table.info.repected"/>">
									<label class="icone_green"></label>
								</button>
								<button class="btn btn-xs tooltips" title="" data-original-title="<spring:message code="application.fotter.table.info.Notrepected"/>">
									<label class="icone_red"></label>
								</button>
