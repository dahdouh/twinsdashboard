        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			
              ...
              <div class="navbar-form navbar-left form-small"> 
	              ...
	              <a class="form-group" href ="${pageContext.request.contextPath}/dashboard/team/add"> 
	              	<button href="" class="btn btn-success" > 

			                          <i class="icon-plus"></i> <spring:message code="application.header.add.dashboardmanager.team"/>
	              	 </button>
	              </a>
              </div>
            ...
            <div class="widget">
			 ...
			 <c:when test="${not empty teams}">
	                <table class="footable table table-bordered table-hover default footable-loaded">
	                  ...
	                  <tbody>
                  			<c:forEach items="${teams}" var="m" >
		                    <tr>
		                      <td class="footable-visible"> ${m.nom}</td>
		                      <td class="footable-visible"> ${m.desc}</td>
		                      <td class="footable-visible">
		                      <fmt:formatDate value="${m.date_creation}" pattern="yyyy-MM-dd hh:mm:ss"/>
		                      </td>
		                       ...
		                       <div align="center">
 				                    <span>
				                      <button title="" data-original-title="" class="btn btn-xs btn-success" 
				                       onclick="location.href = '${pageContext.request.contextPath}/dashboard/team/update/${m.id_equipe}';"> <i class="icon-edit"></i> </button>
				                    </span>
				                    ...
				                    <span>
				                       <button title="" data-original-title="" class="btn btn-xs btn-danger ajax-delete-record" data-popconfirm-yes="<spring:message code="application.crud.yes"/>" data-popconfirm-no="<spring:message code="application.crud.no"/>" 
				                        ...
				                        onclick="location.href = '${pageContext.request.contextPath}/dashboard/team/delete/${m.id_equipe}';"> <i class="icon-trash"></i> </button>
				                   </span>
				                   <span>
								        <button title="" data-original-title="" class="btn btn-xs btn-primary"
								          onclick="location.href = '${pageContext.request.contextPath}/dashboard/team/${m.id_equipe}/member';"> 
								          <i class="icon-hand-right"></i> <spring:message code="application.admin.user.memebreequipe"/>
								        </button>
								   </span>
