...
<tiles:insertDefinition name="DashboardMangerTemplate">
    ...
    <div class="modal-dialog">
      <form:form  modelAttribute="projet" method="post" action="${pageContext.request.contextPath}/dashboard/project/update/${projet.id_projet}">
        <div class="modal-content">
          <div class="modal-header">
            <!--full screen icon - custom.js-->
            <button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
            <!--full screen icon - custom.js-->
            <h4 class="modal-title">  <spring:message code="application.header.update.dashboardmanager.project"/> </h4>
          </div>
          <div class="modal-body">
           ...
           <div class="form-group" style="margin-bottom:10px;">
             ...
             <div class="col-lg-12">
               <form:input class="form-control pickadate" path="date_creation" required="true"/>
               <label class="jquery-validation-error" for="clients_company_name"> <form:errors path="date_creation" cssClass="error" /> </label>
              </div>
            </div>
            
            <div class="form-group" style="margin-bottom:10px;">
              <label class="control-label col-lg-12" style="width:150px;"> <spring:message code="application.project.desc"/>  </label>
              <div class="col-lg-12">
