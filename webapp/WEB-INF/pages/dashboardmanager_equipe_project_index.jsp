		        ...
		        <div class="container-fluid">
		          ...
		          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			             
		              ...
		              <div class="navbar-form navbar-left form-small"> 
			              ...
			              <a class="form-group" href ="${pageContext.request.contextPath}/dashboard/${projet.id_projet}/team/add"> 
		        ...
		        <c:if test="${not empty succesMessage}">
		          ...
		          <div class="col-md-12">
		            <div class="widget">
		              ...
		              <c:choose>
			 <c:when test="${not empty projet.equipes}">
	                <table class="footable table table-bordered table-hover default footable-loaded">
	                  ...
	                  <tbody>
                  			<c:forEach items="${projet.equipes}" var="m" >
		                    <tr>
		                       ...
		                       <div align="center">
				                    ...
				                    <span>
				                       <button title="" data-original-title="" class="btn btn-xs btn-danger ajax-delete-record" data-popconfirm-yes="<spring:message code="application.crud.yes"/>" data-popconfirm-no="<spring:message code="application.crud.no"/>" 
				                        ...
				                        onclick="location.href = '${pageContext.request.contextPath}/dashboard/${projet.id_projet}/team/delete/${m.id_equipe}';"> <i class="icon-trash"></i> </button>
				                   </span>
				                        
 		                           <span>
								        <button title="" data-original-title="" class="btn btn-xs btn-primary"
								          onclick="location.href = '${pageContext.request.contextPath}/dashboard/${projet.id_projet}/team/${m.id_equipe}/member';"> 
			                  ...
			                  <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td colspan="4"><div align="center">
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                          <h2> Aucun Equipe n'est trouvée. </h2>
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                        </div></td>
			                    </tr>
