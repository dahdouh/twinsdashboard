  ...
  <div class="matter">
   ...
   <div class="row">
    <div class="modal-dialog">
      <form:form  modelAttribute="action" method="post" action="${pageContext.request.contextPath}/permission/update/${action.id_action}">
        <div class="modal-content">
          <div class="modal-header">
            <!--full screen icon - custom.js-->
            <button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
            <!--full screen icon - custom.js-->
            <h4 class="modal-title">  <spring:message code="application.header.update.permission"/> </h4>
          </div>
