...
<tiles:insertDefinition name="AdminTemplate">
    ...
    <div class="modal-dialog">
      <form:form  modelAttribute="client" method="post" action="${pageContext.request.contextPath}/admin/client/update/${client.id_u}">
        <div class="modal-content">
          <div class="modal-header">
            <!--full screen icon - custom.js-->
            <button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
            <!--full screen icon - custom.js-->
            <h4 class="modal-title">  <spring:message code="application.header.update.client"/> </h4>
          </div>
          <div class="modal-body">
          
          	<div class="form-group" style="margin-bottom:10px;">
              <label class="control-label col-lg-12" style="width:150px;"> <spring:message code="application.user.societe"/> </label>
             <div class="col-lg-12">
               <form:input class="form-control" path="societe" />
               <label class="jquery-validation-error" for="clients_company_name"> <form:errors path="societe" cssClass="error" /> </label>
              </div>
            </div>
