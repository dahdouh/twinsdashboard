            ...
            <div class="widget">
              <div class="widget-content">
              	...
              	<div class="widget-foot">
	                 <!--WI_PAGINATION-->
	                 <ul class="">
	                   <li><h2> <spring:message code="application.header.table.invited"/> </h2></li>
	                 </ul>
	                 <!--WI_PAGINATION-->
			 ...
			 <c:when test="${not empty users}">
	                <table class="footable table table-bordered table-hover default footable-loaded">
	                  ...
	                  <tbody>
		                    ...
		                    <tr>
		                      <td class="footable-visible"> ${c.nom} ${c.prenom}</td>
			                  ...
			                  <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td colspan="4"><div align="center">
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                          <h2> Jusqu'au maintenant vous êtes la seule personne invitée au événement. </h2>
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                        </div></td>
			                    </tr>
