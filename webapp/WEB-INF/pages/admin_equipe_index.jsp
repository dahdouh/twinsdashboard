      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			
            <form class="navbar-form navbar-left form-small" method="post" action="${pageContext.request.contextPath}/admin/teamember/search">
				...
				<div class="form-group">
				<button class="btn btn-primary" type="submit"> <spring:message code="application.header.search.team"/></button>
				</div>
			</form>
              ...
              <div class="navbar-form navbar-left form-small"> 
	              ...
	              <a class="form-group" href ="${pageContext.request.contextPath}/admin/teamember/add"> 
	              	<button href="" class="btn btn-success" >  <i class="icon-plus"></i> <spring:message code="application.header.add.team"/></button>
	              </a>
              </div>
          ...
          <div class="col-md-12">
            <div class="widget">
	          ...
	          <div class="widget-foot">
	                 <!--WI_PAGINATION-->
	                 <ul class="">
	                   <li><h2> <spring:message code="application.header.table.teamember"/> </h2></li>
	                 </ul>
	                 <!--WI_PAGINATION-->
	                <div class="clearfix"></div>
	            </div>
              <c:choose>
			 <c:when test="${not empty teamembers}">
	                <table class="footable table table-bordered table-hover default footable-loaded">
	                  ...
	                  <tbody>
                  			<c:forEach items="${teamembers}" var="m" >
		                    <tr>
		                      <td class="footable-visible"> ${m.nom}</td>
		                      <td class="footable-visible">${m.prenom}
		                      </td>
		                      <td class="footable-visible">${m.tel}</td>
		                      <td class="footable-visible">${m.email}</td>
		                      <td class="footable-visible">${m.adresse}</td>
		                      ...
		                      <!--edit-->
		                        ...
		                        onclick="location.href = '${pageContext.request.contextPath}/admin/teamember/update/${m.id_u}';"> <i class="icon-edit"></i> </button>
		                       </span>
		                      </td>
		                      <td>
		                      <span>
		                       <button title="" data-original-title="" class="btn btn-xs btn-danger ajax-delete-record" data-popconfirm-yes="<spring:message code="application.crud.yes"/>" data-popconfirm-no="<spring:message code="application.crud.no"/>" 
		                        ...
		                        onclick="location.href = '${pageContext.request.contextPath}/admin/teamember/delete/${m.id_u}';"> <i class="icon-trash"></i> </button>
		                       </span>
		                        <!--delete -->
			                  ...
			                  <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td colspan="4"><div align="center">
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                          <h2> Aucun Membre Equipe n'est trouvé. </h2>
			                          <p>&nbsp;</p>
			                          <p>&nbsp;</p>
			                        </div></td>
			                    </tr>
